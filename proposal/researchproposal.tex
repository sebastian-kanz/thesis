\documentclass[
    ...
    \title{
        ...
        Directed acyclic graphs as backbone solution for IOT applications
        % ##########################################
    ...
    \begin{document}
      \maketitle
        \begin{abstract}
            ...
            \ifthenelse{\equal{en}{\lang}}{test}{testen}
            % ##########################################
        ...
        \begin{description}[style=unboxed]
            ...
            \item [\questionThree{\lang}]
                ...
                % answer the questions 'Which IOT usecases are suitable for utilizing DLT technique?', 'Which DLT fits best as an IOT backbone solution?' and ''
