 ...
 * @notice https://github.com/pouladzade/Seriality/blob/master/src/SizeOf.sol
 */
...
contract  SizeOf {
    ...
    function sizeOfAddress() internal pure  returns(uint){
        return 20;
    }
    ...
    function sizeOfSignature() internal pure returns(uint) {
      return 65;
    }
