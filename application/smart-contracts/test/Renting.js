...
contract("Renting", function() {    let owner;
    ...
    it("should be possible to create a RentalAgreement", async () => {
      ...
      console.log(await renting.createRenting.estimateGas(tenant, signature, device, usageFee, contractTerm));
    ...
    //   await renting.createRenting(accounts[3], signature4, device, usageFee, contractTerm);
    //
